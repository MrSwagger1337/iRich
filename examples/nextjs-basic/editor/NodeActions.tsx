/**
 * Floating node actions toolbar demonstrating useIRichNodeActions hook from @irich/react.
 */

'use client';

import React from 'react';
import { useIRichNodeActions } from '@irich/react';
...
export function NodeActions({ nodeId, nodeType }: NodeActionsProps) {
  const {
    canDelete,
    canDuplicate,
    canMoveUp,
  ...
  return (
    <div className="irich-node-actions" onClick={(e) => e.stopPropagation()}>
      <div
